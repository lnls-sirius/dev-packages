...
class MagnetPowerSupplyFamilyTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.ma = MagnetPowerSupply("SI-Fam:MA-QDA", dipole, use_vaca=True)
    ...
    def test_loop_set_strength(self):
        ...
        strengths = [self.ma._conv_current_2_strength(current, self.ma._dipole.current_sp) for current in currents]
