...
class TestCurrInfoCSDevice(TestCase):
    ...
    def test_get_lifetime_database(self):
        ...
        self.assertTrue('BuffAutoRstDCurr-SP' in db)
        self.assertTrue('BuffAutoRstDCurr-RB' in db)
        self.assertTrue('BuffFirstSplTimestamp-Mon' in db)
        self.assertTrue('BuffFirstSplTimestampBPM-Mon' in db)
        self.assertTrue('BuffLastSplTimestamp-Mon' in db)
        self.assertTrue('BuffLastSplTimestampBPM-Mon' in db)
        ...
        self.assertEqual(db['BuffAutoRstDCurr-SP']['unit'], 'mA')
        self.assertEqual(db['BuffAutoRstDCurr-RB']['unit'], 'mA')
