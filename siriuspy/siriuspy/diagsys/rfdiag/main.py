...
class RFDiagApp(_App):
    ...
    def _create_computed_pvs(self, *args):
        ...
        # DiagStatus-Mon
        pvs = [None]*4
        pvs[_BORFStatusPV.PV_SIRIUS_INTLK] = 'BO-05D:RF-Intlk:BO-Mon'
        pvs[_BORFStatusPV.PV_LLRF_INTLK] = 'BO-05D:RF-LLRF:Status-Mon'
        ...
        # DiagStatus-Mon
        pvs = [None]*5
        pvs[_SIRFStatusPV.PV_SIRIUS_INTLK] = 'SI-02SB:RF-Intlk:SIA-Mon'
        pvs[_SIRFStatusPV.PV_LLRF_INTLK] = 'SI-02SB:RF-LLRF:Intlk-Mon'
