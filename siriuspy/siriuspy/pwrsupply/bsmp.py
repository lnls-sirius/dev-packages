...
class FBPEntities(Entities):
    ...
    Curves = []
    Functions = [
        {'id': 0, 'i_size': 0, 'i_type': None, 'o_size': 1, 'o_type': 'int'},
        {'id': 1, 'i_size': 0, 'i_type': None, 'o_size': 1, 'o_type': 'int'},
        {'id': 2, 'i_size': 0, 'i_type': None, 'o_size': 1, 'o_type': 'int'},
        {'id': 3, 'i_size': 0, 'i_type': None, 'o_size': 1, 'o_type': 'int'},
        {'id': 4, 'i_size': 2, 'i_type': 'int', 'o_size': 1, 'o_type': 'int'},
        {'id': 5, 'i_size': 2, 'i_type': 'int', 'o_size': 1, 'o_type': 'int'},
        {'id': 6, 'i_size': 0, 'i_type': None, 'o_size': 1, 'o_type': 'int'},
        {'id': 7, 'i_size': 0, 'i_type': None, 'o_size': 1, 'o_type': 'int'},
        {'id': 8, 'i_size': 2, 'i_type': 'int', 'o_size': 1, 'o_type': 'int'},
        {'id': 9, 'i_size': 2, 'i_type': 'int', 'o_size': 1, 'o_type': 'int'},
        {'id': 10, 'i_size': 2, 'i_type': 'int', 'o_size': 1, 'o_type': 'int'},
        {'id': 11, 'i_size': 2, 'i_type': 'int', 'o_size': 1, 'o_type': 'int'},
        {'id': 12, 'i_size': 4, 'i_type': 'int', 'o_size': 1, 'o_type': 'int'},
        {'id': 13, 'i_size': 0, 'i_type': None, 'o_size': 1, 'o_type': 'int'},
        {'id': 14, 'i_size': 0, 'i_type': None, 'o_size': 1, 'o_type': 'int'},
        {'id': 15, 'i_size': 0, 'i_type': None, 'o_size': 0, 'o_type': None},
        {'id': 16, 'i_size': 4, 'i_type': Types.t_float, 'o_size': 1,
         'o_type': 'int'},
