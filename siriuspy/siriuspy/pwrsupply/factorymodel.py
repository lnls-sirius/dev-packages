...
class FactoryFAC_2P4S_DCDC(Factory_FAC):
    ...
    _variables = {
        ...
        'IIBInductorTemperature-Mon': _bsmp.ConstFAC_2P4S_DCDC.V_TEMP_INDUCTOR_IIB_1,
        'IIBHeatSinkTemperature-Mon': _bsmp.ConstFAC_2P4S_DCDC.V_TEMP_HEATSINK_IIB_1,
        'IIBInductorTemperature-Mon': _bsmp.ConstFAC_2P4S_DCDC.V_TEMP_INDUCTOR_IIB_2,
        'IIBHeatSinkTemperature-Mon': _bsmp.ConstFAC_2P4S_DCDC.V_TEMP_HEATSINK_IIB_2,
        'IIBInductorTemperature-Mon': _bsmp.ConstFAC_2P4S_DCDC.V_TEMP_INDUCTOR_IIB_3,
        'IIBHeatSinkTemperature-Mon': _bsmp.ConstFAC_2P4S_DCDC.V_TEMP_HEATSINK_IIB_3,
        'IIBInductorTemperature-Mon': _bsmp.ConstFAC_2P4S_DCDC.V_TEMP_INDUCTOR_IIB_4,
        'IIBHeatSinkTemperature-Mon': _bsmp.ConstFAC_2P4S_DCDC.V_TEMP_HEATSINK_IIB_4,
        'IIBInductorTemperature-Mon': _bsmp.ConstFAC_2P4S_DCDC.V_TEMP_INDUCTOR_IIB_5,
        'IIBHeatSinkTemperature-Mon': _bsmp.ConstFAC_2P4S_DCDC.V_TEMP_HEATSINK_IIB_5,
        'IIBInductorTemperature-Mon': _bsmp.ConstFAC_2P4S_DCDC.V_TEMP_INDUCTOR_IIB_6,
        'IIBHeatSinkTemperature-Mon': _bsmp.ConstFAC_2P4S_DCDC.V_TEMP_HEATSINK_IIB_6,
        'IIBInductorTemperature-Mon': _bsmp.ConstFAC_2P4S_DCDC.V_TEMP_INDUCTOR_IIB_7,
        'IIBHeatSinkTemperature-Mon': _bsmp.ConstFAC_2P4S_DCDC.V_TEMP_HEATSINK_IIB_7,
        'IIBInductorTemperature-Mon': _bsmp.ConstFAC_2P4S_DCDC.V_TEMP_INDUCTOR_IIB_8,
        'IIBHeatSinkTemperature-Mon': _bsmp.ConstFAC_2P4S_DCDC.V_TEMP_HEATSINK_IIB_8,
        'IntlkIIB1-Mon': _bsmp.ConstFAC_2P4S_DCDC.V_IIB_INTERLOCKS_1,
        'IntlkIIB2-Mon': _bsmp.ConstFAC_2P4S_DCDC.V_IIB_INTERLOCKS_2,
        'IntlkIIB3-Mon': _bsmp.ConstFAC_2P4S_DCDC.V_IIB_INTERLOCKS_3,
        'IntlkIIB4-Mon': _bsmp.ConstFAC_2P4S_DCDC.V_IIB_INTERLOCKS_4,
        'IntlkIIB5-Mon': _bsmp.ConstFAC_2P4S_DCDC.V_IIB_INTERLOCKS_5,
        'IntlkIIB6-Mon': _bsmp.ConstFAC_2P4S_DCDC.V_IIB_INTERLOCKS_6,
        'IntlkIIB7-Mon': _bsmp.ConstFAC_2P4S_DCDC.V_IIB_INTERLOCKS_7,
        'IntlkIIB8-Mon': _bsmp.ConstFAC_2P4S_DCDC.V_IIB_INTERLOCKS_8,
    }
    ...
    def parameters(self):
        """PRU Controller parameters."""
        return PRUCParms_FAC_2P4S_DCDC
...
class PRUCParms_FAC_2P4S_DCDC(_PRUCParms):
    ...
    groups[_PRUCParms.ALLRELEVANT] = (
        ...
        ConstBSMP.V_DRIVER_ERROR_1_IIB_2,
        ConstBSMP.V_DRIVER_ERROR_2_IIB_2,
        ConstBSMP.V_I_INPUT_IIB_3,
        ConstBSMP.V_I_OUTPUT_IIB_3,
        ConstBSMP.V_V_INPUT_IIB_3,
        ConstBSMP.V_TEMP_INDUCTOR_IIB_3,
        ConstBSMP.V_TEMP_HEATSINK_IIB_3,
        ConstBSMP.V_DRIVER_ERROR_1_IIB_3,
        ConstBSMP.V_DRIVER_ERROR_2_IIB_3,
        ConstBSMP.V_I_INPUT_IIB_4,
        ConstBSMP.V_I_OUTPUT_IIB_4,
        ConstBSMP.V_V_INPUT_IIB_4,
        ConstBSMP.V_TEMP_INDUCTOR_IIB_4,
        ConstBSMP.V_TEMP_HEATSINK_IIB_4,
        ConstBSMP.V_DRIVER_ERROR_1_IIB_4,
        ConstBSMP.V_DRIVER_ERROR_2_IIB_4,
        ConstBSMP.V_I_INPUT_IIB_5,
        ConstBSMP.V_I_OUTPUT_IIB_5,
        ConstBSMP.V_V_INPUT_IIB_5,
        ConstBSMP.V_TEMP_INDUCTOR_IIB_5,
        ConstBSMP.V_TEMP_HEATSINK_IIB_5,
        ConstBSMP.V_DRIVER_ERROR_1_IIB_5,
        ConstBSMP.V_DRIVER_ERROR_2_IIB_5,
        ConstBSMP.V_I_INPUT_IIB_6,
        ConstBSMP.V_I_OUTPUT_IIB_6,
        ConstBSMP.V_V_INPUT_IIB_6,
        ConstBSMP.V_TEMP_INDUCTOR_IIB_6,
        ConstBSMP.V_TEMP_HEATSINK_IIB_6,
        ConstBSMP.V_DRIVER_ERROR_1_IIB_6,
        ConstBSMP.V_DRIVER_ERROR_2_IIB_6,
        ConstBSMP.V_I_INPUT_IIB_6,
        ConstBSMP.V_I_OUTPUT_IIB_7,
        ConstBSMP.V_V_INPUT_IIB_7,
        ConstBSMP.V_TEMP_INDUCTOR_IIB_7,
        ConstBSMP.V_TEMP_HEATSINK_IIB_7,
        ConstBSMP.V_DRIVER_ERROR_1_IIB_7,
        ConstBSMP.V_DRIVER_ERROR_2_IIB_7,
        ConstBSMP.V_I_INPUT_IIB_8,
        ConstBSMP.V_I_OUTPUT_IIB_8,
        ConstBSMP.V_V_INPUT_IIB_8,
        ConstBSMP.V_TEMP_INDUCTOR_IIB_8,
        ConstBSMP.V_TEMP_HEATSINK_IIB_8,
        ConstBSMP.V_DRIVER_ERROR_1_IIB_8,
        ConstBSMP.V_DRIVER_ERROR_2_IIB_8,
        ConstBSMP.V_IIB_INTERLOCKS_1,
        ConstBSMP.V_IIB_INTERLOCKS_2,
        ConstBSMP.V_IIB_INTERLOCKS_3,
        ConstBSMP.V_IIB_INTERLOCKS_4,
        ConstBSMP.V_IIB_INTERLOCKS_5,
        ConstBSMP.V_IIB_INTERLOCKS_6,
        ConstBSMP.V_IIB_INTERLOCKS_7,
        ConstBSMP.V_IIB_INTERLOCKS_8,)
    groups[_PRUCParms.SYNCOFF] = (
        # --- common variables
        ConstBSMP.V_PS_STATUS,
        ConstBSMP.V_PS_SETPOINT,
