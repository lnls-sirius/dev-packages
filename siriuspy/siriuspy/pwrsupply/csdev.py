...
class ETypes(_csdev.ETypes):
    ...
    IIB_ALARMS_FAP_2P2S = (
        ...
        'Sobre-corrente no IGBT 1', 'Sobre-corrente no IGBT 2',
        'Sobre-temperatura no IGBT 1', 'Sobre-temperatura no IGBT 2',
        'Sobre-tensao nos drivers dos IGBTs', 'Sobre-corrente no driver do IGBT 1',
        'Sobre-corrente no driver do IGBT 2', 'Sobre-temperatura nos indutores',
        'Sobre-temperatura no dissipador', 'Alta corrente de fuga',
        'Sobre-temperatura na placa IIB', 'Alta umidade relativa', 'Bit14', 'Bit15',
        'Bit16', 'Bit17', 'Bit18', 'Bit19',
        'Bit20', 'Bit21', 'Bit22', 'Bit23',
        'Bit24', 'Bit25', 'Bit26', 'Bit27',
        'Bit28', 'Bit29', 'Bit30', 'Bit31')
...
def _get_ps_FAP_2P2S_propty_database():
    ...
    db_ps = {
        ...
        'Mod1IGBT2IIBCurrent-Mon': {'type': 'float', 'value': 0.0,
                                    'prec': PS_CURRENT_PRECISION,
                                    'unit': 'A'},
        'Mod1IGBT1TemperatureIIB-Mon': {'type': 'float', 'value': 0.0,
                                        'prec': 2,
                                        'unit': 'C'},
        'Mod1IGBT2TemperatureIIB-Mon': {'type': 'float', 'value': 0.0,
                                        'prec': 2,
                                        'unit': 'C'},
        'Mod1IGBTDriverTemperatureIIB-Mon':
            {'type': 'float', 'value': 0.0,
             'prec': 2,
             'unit': 'C'},
        'Mod1IGBT1DriverCurrentIIB-Mon': {
            'type': 'float', 'value': 0.0,
            'prec': PS_CURRENT_PRECISION,
            'unit': 'A'},
        'Mod1IGBT2DriverCurrentIIB-Mon': {
            'type': 'float', 'value': 0.0,
            'prec': PS_CURRENT_PRECISION,
            'unit': 'A'},
        'IIB1InductorTemperature-Mon': {'type': 'float', 'value': 0.0,
        ...
        'IIB1HeatSinkTemperature-Mon': {'type': 'float', 'value': 0.0,
                                        'prec': 2,
                                        'unit': 'C'},
        'Mod1LeakageCurrentIIB-Mon': {
            'type': 'float', 'value': 0.0,
            'prec': PS_CURRENT_PRECISION,
            'unit': 'A'},
        'Mod1TemperatureIIB-Mon': {'type': 'float', 'value': 0.0,
                                   'prec': 2,
                                   'unit': 'C'},
        'Mod1RelativeHumidityIIB-Mon': {
            'type': 'float', 'value': 0.0,
            'prec': 2,
            'unit': '%'},
        'IntlkIIB1-Mon': {'type': 'int', 'value': 0},
        ...
        'Mod1AlarmsIIB-Mon': {'type': 'int', 'value': 0},
        'Mod1AlarmsIIBLabels-Mon': {
            'type': 'string',
        ...
        'Mod2IGBT2IIBCurrent-Mon': {'type': 'float', 'value': 0.0,
                                    'prec': PS_CURRENT_PRECISION,
                                    'unit': 'A'},
        'Mod2IGBT1TemperatureIIB-Mon': {'type': 'float', 'value': 0.0,
                                        'prec': 2,
                                        'unit': 'C'},
        'Mod2IGBT2TemperatureIIB-Mon': {'type': 'float', 'value': 0.0,
                                        'prec': 2,
                                        'unit': 'C'},
        'Mod2IGBTDriverTemperatureIIB-Mon':
            {'type': 'float', 'value': 0.0,
             'prec': 2,
             'unit': 'C'},
        'Mod2IGBT1DriverCurrentIIB-Mon': {
            'type': 'float', 'value': 0.0,
            'prec': PS_CURRENT_PRECISION,
            'unit': 'A'},
        'Mod2IGBT2DriverCurrentIIB-Mon': {
            'type': 'float', 'value': 0.0,
            'prec': PS_CURRENT_PRECISION,
            'unit': 'A'},
        'IIB2InductorTemperature-Mon': {'type': 'float', 'value': 0.0,
        ...
        'IIB2HeatSinkTemperature-Mon': {'type': 'float', 'value': 0.0,
                                        'prec': 2,
                                        'unit': 'C'},
        'Mod2LeakageCurrentIIB-Mon': {
            'type': 'float', 'value': 0.0,
            'prec': PS_CURRENT_PRECISION,
            'unit': 'A'},
        'Mod2TemperatureIIB-Mon': {'type': 'float', 'value': 0.0,
                                   'prec': 2,
                                   'unit': 'C'},
        'Mod2RelativeHumidityIIB-Mon': {
            'type': 'float', 'value': 0.0,
            'prec': 2,
            'unit': '%'},
        'IntlkIIB2-Mon': {'type': 'int', 'value': 0},
        'IntlkIIB2Labels-Cte':  {'type': 'string',
                                 'count': len(_et.IIB_INTLCK_FAP_2P2S),
                                 'value': _et.IIB_INTLCK_FAP_2P2S},
        'Mod2AlarmsIIB-Mon': {'type': 'int', 'value': 0},
        'Mod2AlarmsIIBLabels-Mon': {
            'type': 'string',
            'count': len(_et.IIB_ALARMS_FAP_2P2S),
            'value': _et.IIB_ALARMS_FAP_2P2S},
        ...
        'Mod3IGBT2IIBCurrent-Mon': {'type': 'float', 'value': 0.0,
                                    'prec': PS_CURRENT_PRECISION,
                                    'unit': 'A'},
        'Mod3IGBT1TemperatureIIB-Mon': {'type': 'float', 'value': 0.0,
                                        'prec': 2,
                                        'unit': 'C'},
        'Mod3IGBT2TemperatureIIB-Mon': {'type': 'float', 'value': 0.0,
                                        'prec': 2,
                                        'unit': 'C'},
        'Mod3IGBTDriverTemperatureIIB-Mon':
            {'type': 'float', 'value': 0.0,
             'prec': 2,
             'unit': 'C'},
        'Mod3IGBT1DriverCurrentIIB-Mon': {
            'type': 'float', 'value': 0.0,
            'prec': PS_CURRENT_PRECISION,
            'unit': 'A'},
        'Mod3IGBT2DriverCurrentIIB-Mon': {
            'type': 'float', 'value': 0.0,
            'prec': PS_CURRENT_PRECISION,
            'unit': 'A'},
        'IIB3InductorTemperature-Mon': {'type': 'float', 'value': 0.0,
        ...
        'IIB3HeatSinkTemperature-Mon': {'type': 'float', 'value': 0.0,
                                        'prec': 2,
                                        'unit': 'C'},
        'Mod3LeakageCurrentIIB-Mon': {
            'type': 'float', 'value': 0.0,
            'prec': PS_CURRENT_PRECISION,
            'unit': 'A'},
        'Mod3TemperatureIIB-Mon': {'type': 'float', 'value': 0.0,
                                   'prec': 2,
                                   'unit': 'C'},
        'Mod3RelativeHumidityIIB-Mon': {
            'type': 'float', 'value': 0.0,
            'prec': 2,
            'unit': '%'},
        'IntlkIIB3-Mon': {'type': 'int', 'value': 0},
        'IntlkIIB3Labels-Cte':  {'type': 'string',
                                 'count': len(_et.IIB_INTLCK_FAP_2P2S),
                                 'value': _et.IIB_INTLCK_FAP_2P2S},
        'Mod3AlarmsIIB-Mon': {'type': 'int', 'value': 0},
        'Mod3AlarmsIIBLabels-Mon': {
            'type': 'string',
            'count': len(_et.IIB_ALARMS_FAP_2P2S),
            'value': _et.IIB_ALARMS_FAP_2P2S},
        ...
        'Mod4IGBT2IIBCurrent-Mon': {'type': 'float', 'value': 0.0,
                                    'prec': PS_CURRENT_PRECISION,
                                    'unit': 'A'},
        'Mod4IGBT1TemperatureIIB-Mon': {'type': 'float', 'value': 0.0,
                                        'prec': 2,
                                        'unit': 'C'},
        'Mod4IGBT2TemperatureIIB-Mon': {'type': 'float', 'value': 0.0,
                                        'prec': 2,
                                        'unit': 'C'},
        'Mod4IGBTDriverTemperatureIIB-Mon':
            {'type': 'float', 'value': 0.0,
             'prec': 2,
             'unit': 'C'},
        'Mod4IGBT1DriverCurrentIIB-Mon': {
            'type': 'float', 'value': 0.0,
            'prec': PS_CURRENT_PRECISION,
            'unit': 'A'},
        'Mod4IGBT2DriverCurrentIIB-Mon': {
            'type': 'float', 'value': 0.0,
            'prec': PS_CURRENT_PRECISION,
            'unit': 'A'},
        'IIB4InductorTemperature-Mon': {'type': 'float', 'value': 0.0,
        ...
        'IIB4HeatSinkTemperature-Mon': {'type': 'float', 'value': 0.0,
                                        'prec': 2,
                                        'unit': 'C'},
        'Mod4LeakageCurrentIIB-Mon': {
            'type': 'float', 'value': 0.0,
            'prec': PS_CURRENT_PRECISION,
            'unit': 'A'},
        'Mod4TemperatureIIB-Mon': {'type': 'float', 'value': 0.0,
                                   'prec': 2,
                                   'unit': 'C'},
        'Mod4RelativeHumidityIIB-Mon': {
            'type': 'float', 'value': 0.0,
            'prec': 2,
            'unit': '%'},
        'IntlkIIB4-Mon': {'type': 'int', 'value': 0},
        'IntlkIIB4Labels-Cte':  {'type': 'string',
                                 'count': len(_et.IIB_INTLCK_FAP_2P2S),
                                 'value': _et.IIB_INTLCK_FAP_2P2S},
        'Mod4AlarmsIIB-Mon': {'type': 'int', 'value': 0},
        'Mod4AlarmsIIBLabels-Mon': {
            'type': 'string',
            'count': len(_et.IIB_ALARMS_FAP_2P2S),
            'value': _et.IIB_ALARMS_FAP_2P2S},
    }
