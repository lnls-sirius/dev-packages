...
class ETypes(_csdev.ETypes):
    ...
    HARD_INTLCK_FAC_2S_ACDC = (
        ...
        'Interlock da placa IIB do estagio de entrada do modulo A',
        'Interlock da placa IIB da gaveta de comando do modulo A',
        'Interlock da placa IIB do estagio de entrada do modulo B',
        'Interlock da placa IIB da gaveta de comando do modulo B',
        'Bit10', 'Bit11',
        'Bit12', 'Bit13', 'Bit14', 'Bit15',
        'Bit16', 'Bit17', 'Bit18', 'Bit19',
        'Bit20', 'Bit21', 'Bit22', 'Bit23',
    ...
    IIBCMD_INTLCK_FAC_2S_ACDC = (
        ...
        'Sobre-tensao do módulo de saida',
...
def _get_ps_FAC_2S_DCDC_propty_database():
    ...
    db_ps = {
        ...
        'VoltageInputIIB1-Mon': {'type': 'float', 'value': 0.0,
                                 'prec': PS_CURRENT_PRECISION,
                                 'unit': 'V'},
        'CurrentInputIIB1-Mon': {'type': 'float', 'value': 0.0,
                                 'prec': PS_CURRENT_PRECISION,
                                 'unit': 'A'},
        'CurrentOutputIIB1-Mon': {'type': 'float', 'value': 0.0,
                                  'prec': PS_CURRENT_PRECISION,
                                  'unit': 'A'},
        'IGBT1TemperatureIIB1-Mon': {'type': 'float', 'value': 0.0,
                                     'prec': 2, 'unit': 'C'},
        'IGBT2TemperatureIIB1-Mon': {'type': 'float', 'value': 0.0,
                                     'prec': 2, 'unit': 'C'},
        'InductorsTemperatureIIB1-Mon': {'type': 'float', 'value': 0.0,
                                         'prec': 2, 'unit': 'C'},
        'HeatSinkTemperatureIIB1-Mon': {'type': 'float', 'value': 0.0,
                                        'prec': 2, 'unit': 'C'},
        'IGBTDriverVoltageIIB1-Mon': {'type': 'float', 'value': 0.0,
                                      'prec': PS_CURRENT_PRECISION,
                                      'unit': 'V'},
        'IGBT1DriverCurrentIIB1-Mon': {'type': 'float', 'value': 0.0,
                                       'prec': PS_CURRENT_PRECISION,
                                       'unit': 'A'},
        'IGBT2DriverCurrentIIB1-Mon': {'type': 'float', 'value': 0.0,
                                       'prec': PS_CURRENT_PRECISION,
                                       'unit': 'A'},
        'BoardTemperatureIIB1-Mon': {'type': 'float', 'value': 0.0,
                                     'prec': 2, 'unit': 'C'},
        'RHIIB1-Mon': {'type': 'float', 'value': 0.0, 'unit': '%'},
        ...
        'AlarmsIIB1-Mon': {'type': 'int', 'value': 0},
        'AlarmsIIB1Labels-Cte': {'type': 'string',
                                 'count': len(_et.IIB_ALARMS_FAC_2S_DCDC),
                                 'value': _et.IIB_ALARMS_FAC_2S_DCDC},
        'VoltageInputIIB2-Mon': {'type': 'float', 'value': 0.0,
                                 'prec': PS_CURRENT_PRECISION,
                                 'unit': 'V'},
        'CurrentInputIIB2-Mon': {'type': 'float', 'value': 0.0,
                                 'prec': PS_CURRENT_PRECISION,
                                 'unit': 'A'},
        'CurrentOutputIIB2-Mon': {'type': 'float', 'value': 0.0,
                                  'prec': PS_CURRENT_PRECISION,
                                  'unit': 'A'},
        'IGBT1TemperatureIIB2-Mon': {'type': 'float', 'value': 0.0,
                                     'prec': 2, 'unit': 'C'},
        'IGBT2TemperatureIIB2-Mon': {'type': 'float', 'value': 0.0,
                                     'prec': 2, 'unit': 'C'},
        'InductorsTemperatureIIB2-Mon': {'type': 'float', 'value': 0.0,
                                         'prec': 2, 'unit': 'C'},
        'HeatSinkTemperatureIIB2-Mon': {'type': 'float', 'value': 0.0,
                                        'prec': 2, 'unit': 'C'},
        'IGBTDriverVoltageIIB2-Mon': {'type': 'float', 'value': 0.0,
                                      'prec': PS_CURRENT_PRECISION,
                                      'unit': 'V'},
        'IGBT1DriverCurrentIIB2-Mon': {'type': 'float', 'value': 0.0,
                                       'prec': PS_CURRENT_PRECISION,
                                       'unit': 'A'},
        'IGBT2DriverCurrentIIB2-Mon': {'type': 'float', 'value': 0.0,
                                       'prec': PS_CURRENT_PRECISION,
                                       'unit': 'A'},
        'BoardTemperatureIIB2-Mon': {'type': 'float', 'value': 0.0,
                                     'prec': 2, 'unit': 'C'},
        'RHIIB2-Mon': {'type': 'float', 'value': 0.0, 'unit': '%'},
        'IntlkIIB2-Mon': {'type': 'int', 'value': 0},
        'IntlkIIB2Labels-Cte': {'type': 'string',
                                'count': len(_et.IIB_INTLCK_FAC_2S_DCDC),
                                'value': _et.IIB_INTLCK_FAC_2S_DCDC},
        'AlarmsIIB2-Mon': {'type': 'int', 'value': 0},
        'AlarmsIIB2Labels-Cte': {'type': 'string',
                                 'count': len(_et.IIB_ALARMS_FAC_2S_DCDC),
                                 'value': _et.IIB_ALARMS_FAC_2S_DCDC},
    }
    propty_db.update(db_ps)
...
def _get_ps_FAC_2S_ACDC_propty_database():
    ...
    db_ps = {
        ...
        'PWMDutyCycle-Mon': {'type': 'float', 'value': 0.0, 'unit': 'p.u.',
                             'prec': PS_CURRENT_PRECISION},
        'CurrentInputIIBIS-Mon': {'type': 'float', 'value': 0.0,
                                  'prec': PS_CURRENT_PRECISION,
                                  'unit': 'A'},
        'VoltageInputIIBIS-Mon': {'type': 'float', 'value': 0.0,
                                  'prec': PS_CURRENT_PRECISION,
                                  'unit': 'V'},
        'IGBTTemperatureIIBIS-Mon': {'type': 'float', 'value': 0.0,
                                     'prec': 2, 'unit': 'C'},
        'IGBTDriverVoltageIIBIS-Mon': {'type': 'float', 'value': 0.0,
                                       'prec': PS_CURRENT_PRECISION,
                                       'unit': 'V'},
        'IGBTDriverCurrentIIBIS-Mon': {'type': 'float', 'value': 0.0,
                                       'prec': PS_CURRENT_PRECISION,
                                       'unit': 'A'},
        'InductorTemperatureIIBIS-Mon': {'type': 'float', 'value': 0.0,
                                         'prec': 2, 'unit': 'C'},
        'HeatSinkTemperatureIIBIS-Mon': {'type': 'float', 'value': 0.0,
                                         'prec': 2, 'unit': 'C'},
        'BoardTemperatureIIBIS-Mon': {'type': 'float', 'value': 0.0,
                                      'prec': 2, 'unit': 'C'},
        'RHIIBIS-Mon': {'type': 'float', 'value': 0.0, 'unit': '%'},
        ...
        'AlarmsIIBIS-Mon': {'type': 'int', 'value': 0},
        'AlarmsIIBISLabels-Cte': {'type': 'string',
                                  'count': len(_et.IIBIS_ALARMS_FAC_2S_ACDC),
                                  'value': _et.IIBIS_ALARMS_FAC_2S_ACDC},
        'VoltageOutputIIBCmd-Mon': {'type': 'float', 'value': 0.0,
                                    'prec': PS_CURRENT_PRECISION,
                                    'unit': 'V'},
        'CapacitorBankVoltageIIBCmd-Mon': {'type': 'float', 'value': 0.0,
                                           'prec': PS_CURRENT_PRECISION,
                                           'unit': 'V'},
        'RectInductorTempIIBCmd-Mon': {'type': 'float', 'value': 0.0,
                                       'prec': 2, 'unit': 'C'},
        'RectHeatSinkTempIIBCmd-Mon': {'type': 'float', 'value': 0.0,
                                       'prec': 2, 'unit': 'C'},
        'ExtBoardsVoltageIIBCmd-Mon': {'type': 'float', 'value': 0.0,
                                       'prec': PS_CURRENT_PRECISION,
                                       'unit': 'V'},
        'AuxBoardCurrentIIBCmd-Mon': {'type': 'float', 'value': 0.0,
                                      'prec': PS_CURRENT_PRECISION,
                                      'unit': 'A'},
        'IDBBoardCurrentIIBCmd-Mon': {'type': 'float', 'value': 0.0,
                                      'prec': PS_CURRENT_PRECISION,
                                      'unit': 'A'},
        'LeakCurrentIIBCmd-Mon': {'type': 'float', 'value': 0.0,
                                  'prec': PS_CURRENT_PRECISION,
                                  'unit': 'A'},
        'BoardTemperatureIIBCmd-Mon': {'type': 'float', 'value': 0.0,
                                       'prec': 2, 'unit': 'C'},
        'RHIIBCmd-Mon': {'type': 'float', 'value': 0.0, 'unit': '%'},
        ...
        'AlarmsIIBCmd-Mon': {'type': 'int', 'value': 0},
        'AlarmsIIBCmdLabels-Cte': {'type': 'string',
                                   'count': len(_et.IIBCMD_ALARMS_FAC_2S_ACDC),
