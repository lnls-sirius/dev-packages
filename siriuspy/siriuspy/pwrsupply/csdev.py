...
class ETypes(_csdev.ETypes):
    ...
    HARD_INTLCK_FBP = (
        ...
        'Sobre-tensao da fonte 1',
        'Sobre-tensao da fonte 2',
        'Sobre-tensao da fonte 3', 'Sub-tensao da saida do bastidor DC-Link',
        'Sub-tensao da fonte 1', 'Sub-tensao da fonte 2',
        'Sub-tensao da fonte 3', 'Sensor de fumaca',
    ...
    IIB_ALARMS_FAP_4P = (
        ...
        'Sobre-corrente no IGBT 1', 'Sobre-corrente no IGBT 2',
        'Sobre-temperatura no IGBT 1', 'Sobre-temperatura no IGBT 2',
        'Sobre-tenaão dos drivers dos IGBTs', 'Sobre-corrente no driver do IGBT 1',
        'Sobre-corrente no driver do IGBT 2', 'Sobre-temperatura nos indutores',
        'Sobre-temperatura no dissipador', 'Alta corrente de fuga',
        'Sobre-temperatura da placa IIB', 'Alta umidade relativa',
        'Bit14', 'Bit15',
