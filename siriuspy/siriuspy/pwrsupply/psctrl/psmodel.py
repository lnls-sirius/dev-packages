...
class PSModelFAC_2S_DCDC(_PSModel):
    ...
    _bsmp_variables = {
        ...
        'VoltageInputIIB1-Mon': _c.V_V_INPUT_IIB_1,
        'CurrentInputIIB1-Mon': _c.V_I_INPUT_IIB_1,
        'CurrentOutputIIB1-Mon': _c.V_I_OUTPUT_IIB_1,
        'IGBT1TemperatureIIB1-Mon': _c.V_TEMP_IGBTS_1_IIB_1,
        'IGBT2TemperatureIIB1-Mon': _c.V_TEMP_IGBTS_2_IIB_1,
        'InductorsTemperatureIIB1-Mon': _c.V_TEMP_INDUCTOR_IIB_1,
        'HeatSinkTemperatureIIB1-Mon': _c.V_TEMP_HEATSINK_IIB_1,
        'IGBTDriverVoltageIIB1-Mon': _c.V_V_DRIVER_IIB_1,
        'IGBT1DriverCurrentIIB1-Mon': _c.V_I_DRIVER_1_IIB_1,
        'IGBT2DriverCurrentIIB1-Mon': _c.V_I_DRIVER_2_IIB_1,
        'BoardTemperatureIIB1-Mon': _c.V_TEMP_BOARD_IIB_1,
        'RHIIB1-Mon': _c.V_RH_IIB_1,
        'IntlkIIB1-Mon': _c.V_IIB_INTERLOCKS_1,
        'AlarmsIIB1-Mon': _c.V_IIB_ALARMS_1,
        'VoltageInputIIB2-Mon': _c.V_V_INPUT_IIB_2,
        'CurrentInputIIB2-Mon': _c.V_I_INPUT_IIB_2,
        'CurrentOutputIIB2-Mon': _c.V_I_OUTPUT_IIB_2,
        'IGBT1TemperatureIIB2-Mon': _c.V_TEMP_IGBTS_1_IIB_2,
        'IGBT2TemperatureIIB2-Mon': _c.V_TEMP_IGBTS_2_IIB_2,
        'InductorsTemperatureIIB2-Mon': _c.V_TEMP_INDUCTOR_IIB_2,
        'HeatSinkTemperatureIIB2-Mon': _c.V_TEMP_HEATSINK_IIB_2,
        'IGBTDriverVoltageIIB2-Mon': _c.V_V_DRIVER_IIB_2,
        'IGBT1DriverCurrentIIB2-Mon': _c.V_I_DRIVER_1_IIB_2,
        'IGBT2DriverCurrentIIB2-Mon': _c.V_I_DRIVER_2_IIB_2,
        'BoardTemperatureIIB2-Mon': _c.V_TEMP_BOARD_IIB_2,
        'RHIIB2-Mon': _c.V_RH_IIB_2,
        'IntlkIIB2-Mon': _c.V_IIB_INTERLOCKS_2,
        'AlarmsIIB2-Mon': _c.V_IIB_ALARMS_2,
        }
...
class PSModelFAC_2S_ACDC(_PSModel):
    ...
    _bsmp_variables = {
        ...
        'PWMDutyCycle-Mon': _c.V_DUTY_CYCLE,
        'CurrentInputIIBIS-Mon': _c.V_I_INPUT_IS_IIB,
        'VoltageInputIIBIS-Mon': _c.V_V_INPUT_IS_IIB,
        'IGBTTemperatureIIBIS-Mon': _c.V_TEMP_IGBT_IS_IIB,
        'IGBTDriverVoltageIIBIS-Mon': _c.V_V_DRIVER_IS_IIB,
        'IGBTDriverCurrentIIBIS-Mon': _c.V_I_DRIVER_IS_IIB,
        'InductorTemperatureIIBIS-Mon': _c.V_TEMP_INDUCTOR_IS_IIB,
        'HeatSinkTemperatureIIBIS-Mon': _c.V_TEMP_HEATSINK_IS_IIB,
        'BoardTemperatureIIBIS-Mon': _c.V_TEMP_BOARD_IS_IIB,
        'RHIIBIS-Mon': _c.V_RH_IS_IIB,
        'IntlkIIBIS-Mon': _c.V_IIB_INTERLOCKS_IS,
        'AlarmsIIBIS-Mon': _c.V_IIB_ALARMS_IS,
        'VoltageOutputIIBCmd-Mon': _c.V_V_OUTPUT_CMD_IIB,
        'CapacitorBankVoltageIIBCmd-Mon': _c.V_V_CAPBANK_CMD_IIB,
        'RectInductorTempIIBCmd-Mon': _c.V_TEMP_RECT_INDUCTOR_CMD_IIB,
        'RectHeatSinkTempIIBCmd-Mon': _c.V_TEMP_RECT_HEATSINK_CMD_IIB,
        'ExtBoardsVoltageIIBCmd-Mon': _c.V_V_EXT_BOARDS_CMD_IIB,
        'AuxBoardCurrentIIBCmd-Mon': _c.V_I_AUX_BOARD_CMD_IIB,
        'IDBBoardCurrentIIBCmd-Mon': _c.V_I_IDB_BOARD_CMD_IIB,
        'LeakCurrentIIBCmd-Mon': _c.V_I_LEAKAGE_CMD_IIB,
        'BoardTemperatureIIBCmd-Mon': _c.V_TEMP_BOARD_CMD_IIB,
        'RHIIBCmd-Mon': _c.V_RH_CMD_IIB,
        'IntlkIIBCmd-Mon': _c.V_IIB_INTERLOCKS_CMD,
        'AlarmsIIBCmd-Mon': _c.V_IIB_ALARMS_CMD,
        }
