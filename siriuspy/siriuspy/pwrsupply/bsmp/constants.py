...
class ConstPSBSMP:
    ...
    P_CTRL_SLEW_RATE_SLOWREF = 18
    P_CTRL_SLEW_RATE_SIGGEN_AMP = 19
    P_CTRL_SLEW_RATE_SIGGEN_OFFSET = 20
    P_CTRL_SLEW_RATE_WFMREF = 21
    # ----- class PWM -----
    P_PWM_FREQ = 22
    P_PWM_DEAD_TIME = 23
    P_PWM_MAX_DUTY = 24
    P_PWM_MIN_DUTY = 25
    P_PWM_MAX_DUTY_OPEN_LOOP = 26
    P_PWM_MIN_DUTY_OPEN_LOOP = 27
    P_PWM_LIM_DUTY_SHARE = 28
    # ----- class HRADC -----
    ...
    P_HARD_INTLK_DEBOUNCE_TIME = 49
    P_HARD_INTLK_RESET_TIME = 50
    P_SOFT_INTLK_DEBOUNCE_TIME = 51
    P_SOFT_INTLK_RESET_TIME = 52
    # ---- Scope -----
