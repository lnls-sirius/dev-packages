...
class EntitiesPS(_Entities):
    ...
    _ps_functions = (
        ...
        {'eid': _ConstPSBSMP.F_SELECT_PS_MODEL,
         'i_type': (_Types.T_UINT16, ), 'o_type': (_Types.T_UINT8,)},
        {'eid': _ConstPSBSMP.F_RESET_INTERLOCKS,
         'i_type': (), 'o_type': (_Types.T_UINT8, )},
        {'eid': _ConstPSBSMP.F_REMOTE_INTERFACE,
         'i_type': (), 'o_type': (_Types.T_UINT8, )},
        {'eid': _ConstPSBSMP.F_SET_SERIAL_ADDRESS,
         'i_type': (_Types.T_UINT16, ), 'o_type': (_Types.T_UINT8,)},
        ...
        {'eid': _ConstPSBSMP.F_LOCK_UDC,
         'i_type': (_Types.T_UINT16,), 'o_type': (_Types.T_UINT8,)},
        {'eid': _ConstPSBSMP.F_CFG_BUF_SAMPLES,
         'i_type': (_Types.T_UINT32,), 'o_type': (_Types.T_UINT8,)},
        {'eid': _ConstPSBSMP.F_ENABLE_BUF_SAMPLES,
         'i_type': (), 'o_type': (_Types.T_UINT8, )},
        {'eid': _ConstPSBSMP.F_DISABLE_BUF_SAMPLES,
         'i_type': (), 'o_type': (_Types.T_UINT8, )},
