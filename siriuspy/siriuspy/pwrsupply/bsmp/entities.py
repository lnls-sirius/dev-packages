...
class Parameters(_Entity):
    ...
    _parameters = {
        ...
        14: {'count': 1, 'var_type': _Types.T_FLOAT, 'unit': 'A/V',
             'init': False, 'Op': True},
        15: {'count': 1, 'var_type': _Types.T_FLOAT, 'unit': 'A/V',
             'init': False, 'Op': True},
        16: {'count': 1, 'var_type': _Types.T_FLOAT, 'unit': '',
             'init': False, 'Op': True},
        17: {'count': 1, 'var_type': _Types.T_FLOAT, 'unit': '',
             'init': False, 'Op': True},
        ...
        20: {'count': 1, 'var_type': _Types.T_FLOAT, 'unit': 'Ref/s',
             'init': True, 'Op': False},
        21: {'count': 1, 'var_type': _Types.T_FLOAT, 'unit': 'Ref/s',
             'init': True, 'Op': False},
        # ----- class PWM -----
        22: {'count': 1, 'var_type': _Types.T_FLOAT, 'unit': 'Hz',
             'init': True, 'Op': False},
        23: {'count': 1, 'var_type': _Types.T_FLOAT, 'unit': 'ns',
             'init': True, 'Op': False},
        ...
        28: {'count': 1, 'var_type': _Types.T_FLOAT, 'unit': '%',
             'init': False, 'Op': True},
        # ----- class HRADC -----
        29: {'count': 1, 'var_type': _Types.T_FLOAT, 'unit': '',
             'init': True, 'Op': False},
        30: {'count': 1, 'var_type': _Types.T_FLOAT, 'unit': 'MHz',
             'init': True, 'Op': False},
        31: {'count': 1, 'var_type': _Types.T_FLOAT, 'unit': 'Hz',
             'init': True, 'Op': False},
        ...
        35: {'count': 4, 'var_type': _Types.T_FLOAT, 'unit': '',
             'init': True, 'Op': False},
        36: {'count': 4, 'var_type': _Types.T_FLOAT, 'unit': '',
             'init': True, 'Op': False},
        # ----- class SigGen -----
        37: {'count': 1, 'var_type': _Types.T_FLOAT, 'unit': '',
             'init': True, 'Op': False},
        38: {'count': 1, 'var_type': _Types.T_FLOAT, 'unit': '',
             'init': True, 'Op': False},
        39: {'count': 1, 'var_type': _Types.T_FLOAT, 'unit': 'Hz',
             'init': False, 'Op': True},
        40: {'count': 1, 'var_type': _Types.T_FLOAT, 'unit': 'A/V/%',
             'init': False, 'Op': True},
        41: {'count': 1, 'var_type': _Types.T_FLOAT, 'unit': 'A/V/%',
             'init': False, 'Op': True},
        42: {'count': 4, 'var_type': _Types.T_FLOAT, 'unit': '',
             'init': True, 'Op': False},
        # ----- class WfmRef -----
        43: {'count': 1, 'var_type': _Types.T_FLOAT, 'unit': '',
             'init': True, 'Op': False},
        44: {'count': 1, 'var_type': _Types.T_FLOAT, 'unit': '',
             'init': True, 'Op': False},
        45: {'count': 1, 'var_type': _Types.T_FLOAT, 'unit': 'A/V/%',
             'init': False, 'Op': True},
        46: {'count': 1, 'var_type': _Types.T_FLOAT, 'unit': 'A/V/%',
             'init': False, 'Op': True},
        # ----- class Analog Variables -----
        47: {'count': 64, 'var_type': _Types.T_FLOAT, 'unit': '',
             'init': False, 'Op': True},
        48: {'count': 64, 'var_type': _Types.T_FLOAT, 'unit': '',
             'init': False, 'Op': True},
        ...
        51: {'count': 32, 'var_type': _Types.T_FLOAT, 'unit': 'us',
             'init': True, 'Op': False},
        52: {'count': 32, 'var_type': _Types.T_FLOAT, 'unit': 'us',
             'init': True, 'Op': False},
        # ---- Scope -----
        53: {'count': 1, 'var_type': _Types.T_FLOAT, 'unit': 'Hz',
             'init': True, 'Op': False},
        54: {'count': 1, 'var_type': _Types.T_FLOAT, 'unit': '',
             'init': True, 'Op': False},
          }
...
class EntitiesPS(_Entities):
    ...
    _ps_functions = (
        ...
        {'eid': _ConstPSBSMP.F_RESET_COUNTERS,
         'i_type': (), 'o_type': (_Types.T_UINT8,)},
        {'eid': _ConstPSBSMP.F_SCALE_WFMREF,
