...
_pvs_bbb_proc_l = [
    ...
    ['SI-Glob:DI-BbBProc-L:FBS_0_CHAN_ON', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_0_DRV0', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_0_DRV1', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_0_DRV2', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_0_SETSEL', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_0_SG', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_0_TIME', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_1_CHAN_ON', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_1_DRV0', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_1_DRV1', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_1_DRV2', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_1_SETSEL', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_1_SG', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_1_TIME', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_2_CHAN_ON', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_2_DRV0', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_2_DRV1', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_2_DRV2', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_2_SETSEL', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_2_SG', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_2_TIME', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_3_CHAN_ON', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_3_DRV0', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_3_DRV1', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_3_DRV2', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_3_SETSEL', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_3_SG', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_3_TIME', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_4_CHAN_ON', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_4_DRV0', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_4_DRV1', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_4_DRV2', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_4_SETSEL', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_4_SG', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_4_TIME', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_5_CHAN_ON', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_5_DRV0', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_5_DRV1', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_5_DRV2', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_5_SETSEL', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_5_SG', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_5_TIME', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_6_CHAN_ON', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_6_DRV0', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_6_DRV1', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_6_DRV2', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_6_SETSEL', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_6_SG', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_6_TIME', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_7_CHAN_ON', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_7_DRV0', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_7_DRV1', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_7_DRV2', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_7_SETSEL', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_7_SG', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_7_TIME', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_ENABLE', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:FBS_TRIG_IN_SEL', _ZERO_INT, 0],
    ...
    ['SI-Glob:DI-BbBProc-L:DRIVE0_ARB', _EMPTY_NDARRAY_INT, 0],
    ['SI-Glob:DI-BbBProc-L:DRIVE0_ARBLEN', _ZERO_INT, 0],
    ...
    ['SI-Glob:DI-BbBProc-L:DRIVE1_ARB', _EMPTY_NDARRAY_INT, 0],
    ['SI-Glob:DI-BbBProc-L:DRIVE1_ARBLEN', _ZERO_INT, 0],
    ...
    ['SI-Glob:DI-BbBProc-L:DRIVE2_ARB', _EMPTY_NDARRAY_INT, 0],
    ['SI-Glob:DI-BbBProc-L:DRIVE2_ARBLEN', _ZERO_INT, 0],
    ...
    ['SI-Glob:DI-BbBProc-L:CLEAN_WFM', _ZERO_INT, 0],
    ...
    ['SI-Glob:DI-BbBProc-L:SRAM_M1_HIGH', _ZERO_FLOAT, 0],
    ['SI-Glob:DI-BbBProc-L:SRAM_M1_LOW', _ZERO_FLOAT, 0],
    ['SI-Glob:DI-BbBProc-L:SRAM_M1_MODE', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:SRAM_M1_SKEW', _ZERO_FLOAT, 0],
    ['SI-Glob:DI-BbBProc-L:SRAM_M2_HIGH', _ZERO_FLOAT, 0],
    ['SI-Glob:DI-BbBProc-L:SRAM_M2_LOW', _ZERO_FLOAT, 0],
    ['SI-Glob:DI-BbBProc-L:SRAM_M2_MODE', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:SRAM_M2_SKEW', _ZERO_FLOAT, 0],
    ...
    ['SI-Glob:DI-BbBProc-L:SRAM_MD_HIGH', _ZERO_FLOAT, 0],
    ['SI-Glob:DI-BbBProc-L:SRAM_MD_LOW', _ZERO_FLOAT, 0],
    ['SI-Glob:DI-BbBProc-L:SRAM_MD_MODE', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:SRAM_MD_SKEW', _ZERO_FLOAT, 0],
    ...
    ['SI-Glob:DI-BbBProc-L:BRAM_M1_HIGH', _ZERO_FLOAT, 0],
    ['SI-Glob:DI-BbBProc-L:BRAM_M1_LOW', _ZERO_FLOAT, 0],
    ['SI-Glob:DI-BbBProc-L:BRAM_M1_MODE', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:BRAM_M1_SKEW', _ZERO_FLOAT, 0],
    ['SI-Glob:DI-BbBProc-L:BRAM_M2_HIGH', _ZERO_FLOAT, 0],
    ['SI-Glob:DI-BbBProc-L:BRAM_M2_LOW', _ZERO_FLOAT, 0],
    ['SI-Glob:DI-BbBProc-L:BRAM_M2_MODE', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:BRAM_M2_SKEW', _ZERO_FLOAT, 0],
    ...
    ['SI-Glob:DI-BbBProc-L:BRAM_MD_HIGH', _ZERO_FLOAT, 0],
    ['SI-Glob:DI-BbBProc-L:BRAM_MD_LOW', _ZERO_FLOAT, 0],
    ['SI-Glob:DI-BbBProc-L:BRAM_MD_MODE', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:BRAM_MD_SKEW', _ZERO_FLOAT, 0],
    ...
    ['SI-Glob:DI-BbBProc-L:SB_M1_HIGH', _ZERO_FLOAT, 0],
    ['SI-Glob:DI-BbBProc-L:SB_M1_LOW', _ZERO_FLOAT, 0],
    ['SI-Glob:DI-BbBProc-L:SB_M1_MODE', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:SB_M1_SKEW', _ZERO_FLOAT, 0],
    ...
    ['SI-Glob:DI-BbBProc-L:STAT_CA_CLNT_CNT.HIGH', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:STAT_CA_CLNT_CNT.HIHI', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:STAT_CA_CONN_CNT.HIGH', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:STAT_CA_CONN_CNT.HIHI', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:STAT_FD_FREE.LOLO', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:STAT_FD_FREE.LOW', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:STAT_IOC_CPU_LOAD.HIGH', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:STAT_IOC_CPU_LOAD.HIHI', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:STAT_MEM_FREE.LOLO', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:STAT_MEM_FREE.LOW', _ZERO_INT, 0],
    ['SI-Glob:DI-BbBProc-L:STAT_SUSP_TASK_CNT.HIHI', _ZERO_INT, 0],
    ]
