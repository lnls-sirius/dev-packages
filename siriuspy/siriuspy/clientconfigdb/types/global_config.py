...
_pvs_as_ti = [
    ...
    ['SI-01SA:TI-InjNLKckr-CCoilH:DelayRaw-SP', 0, 0],
    ['SI-01SA:TI-InjNLKckr-CCoilH:WidthRaw-SP', 0, 0.0],
    ['SI-01SA:TI-InjNLKckr-CCoilH:NrPulses-SP', 0, 0.0],
    ['SI-01SA:TI-InjNLKckr-CCoilH:Polarity-Sel', 0, 0.0],
    ['SI-01SA:TI-InjNLKckr-CCoilH:Src-Sel', 0, 0.0],
    ['SI-01SA:TI-InjNLKckr-CCoilH:State-Sel', 0, 0.0],
    ['SI-01SA:TI-InjNLKckr-CCoilH:DeltaDelayRaw-SP', 30*[0, ], 0],
    ['SI-01SA:TI-InjNLKckr-CCoilH:LowLvlLock-Sel', 0, 0.0],

    ['SI-01SA:TI-InjNLKckr-CCoilV:DelayRaw-SP', 0, 0],
    ['SI-01SA:TI-InjNLKckr-CCoilV:WidthRaw-SP', 0, 0.0],
    ['SI-01SA:TI-InjNLKckr-CCoilV:NrPulses-SP', 0, 0.0],
    ['SI-01SA:TI-InjNLKckr-CCoilV:Polarity-Sel', 0, 0.0],
    ['SI-01SA:TI-InjNLKckr-CCoilV:Src-Sel', 0, 0.0],
    ['SI-01SA:TI-InjNLKckr-CCoilV:State-Sel', 0, 0.0],
    ['SI-01SA:TI-InjNLKckr-CCoilV:DeltaDelayRaw-SP', 30*[0, ], 0],
    ['SI-01SA:TI-InjNLKckr-CCoilV:LowLvlLock-Sel', 0, 0.0],

    ['AS-Glob:TI-Osc-InjNLKckr:DelayRaw-SP', 0, 0],
    ['AS-Glob:TI-Osc-InjNLKckr:WidthRaw-SP', 0, 0.0],
    ['AS-Glob:TI-Osc-InjNLKckr:NrPulses-SP', 0, 0.0],
    ['AS-Glob:TI-Osc-InjNLKckr:Polarity-Sel', 0, 0.0],
    ['AS-Glob:TI-Osc-InjNLKckr:Src-Sel', 0, 0.0],
    ['AS-Glob:TI-Osc-InjNLKckr:State-Sel', 0, 0.0],
    ['AS-Glob:TI-Osc-InjNLKckr:DeltaDelayRaw-SP', 30*[0, ], 0],
    ['AS-Glob:TI-Osc-InjNLKckr:LowLvlLock-Sel', 0, 0.0],
