...
_pvs_as_ti = [
    ...
    ['SI-Fam:TI-BPM-MonitClk:DelayRaw-SP', 0, 0],
    ['SI-Fam:TI-BPM-MonitClk:WidthRaw-SP', 0, 0.0],
    ['SI-Fam:TI-BPM-MonitClk:NrPulses-SP', 0, 0.0],
    ['SI-Fam:TI-BPM-MonitClk:Polarity-Sel', 0, 0.0],
    ['SI-Fam:TI-BPM-MonitClk:Src-Sel', 0, 0.0],
    ['SI-Fam:TI-BPM-MonitClk:State-Sel', 0, 0.0],
    ['SI-Fam:TI-BPM-MonitClk:DeltaDelayRaw-SP', 30*[0, ], 0],
    ['SI-Fam:TI-BPM-MonitClk:LowLvlLock-Sel', 0, 0.0],
    ['SI-Fam:TI-BPM-MonitClk:Direction-Sel', 0, 0.0],
