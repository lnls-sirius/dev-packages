...
folder_epics_base = _os.environ.get('EPICS_DIR',
                                    default='/usr/local/epics')
folder_lnls_sirius = _os.environ.get('LNLS_SIRIUS',
                                     default=_os.path.join(folder_root,
                                                           'lnls-sirius'))
folder_lnls_fac = _os.environ.get('LNLS_FAC',
                                  default=_os.path.join(folder_root,
                                                        'lnls-fac'))
folder_lnls_ima = _os.environ.get('LNLS_IMA',
                                  default=_os.path.join(folder_root,
                                                        'lnls-ima'))
folder_fac_code = _os.path.join(folder_root, 'lnls-fac')
folder_fac_data = _os.path.join(folder_root, 'data')
folder_lnls_sirius_csslnls = _os.path.join(folder_lnls_sirius,
                                           'org.csstudio.product')
folder_lnls_sirius_discs = _os.path.join(folder_lnls_sirius,
                                         'discs-management')
folder_lnls_sirius_csconstants = _os.path.join(folder_lnls_sirius,
                                               'control-system-constants')
folder_lnls_sirius_dev_packages = _os.path.join(folder_lnls_sirius,
                                                'dev-packages')
...
server_url_ns = _os.environ.get(
                    'SIRIUS_URL_NS',
                    default='http://naming-service-wildfly:8089/names')
server_url_ccdb = _os.environ.get('SIRIUS_URL_CCDB',
                                  default='http://ccdb:8083')
server_url_cables = _os.environ.get('SIRIUS_URL_CABLES',
...
folder_lnls_sirius = _os.environ.get('LNLS_SIRIUS', \
                        default=_os.path.join(folder_root, 'lnls-sirius'))
folder_lnls_fac    = _os.environ.get('LNLS_FAC',    \
                        default=_os.path.join(folder_root, 'lnls-fac'))
folder_lnls_ima    = _os.environ.get('LNLS_IMA',    \
                        default=_os.path.join(folder_root, 'lnls-ima'))
folder_fac_code    = _os.path.join(folder_root, 'lnls-fac')
folder_fac_data    = _os.path.join(folder_root, 'data')
folder_lnls_sirius_csslnls      = _os.path.join(folder_lnls_sirius, \
                                    'org.csstudio.product')
...
server_url_rbac   = _os.environ.get('SIRIUS_URL_RBAC',   \
                        default='https://rbac:8445')
server_url_ns     = _os.environ.get('SIRIUS_URL_NS',     \
                        default='http://naming-service-wildfly:8089/names')
server_url_ccdb   = _os.environ.get('SIRIUS_URL_CCDB',   \
                        default='http://ccdb:8083')
server_url_cables = _os.environ.get('SIRIUS_URL_CABLES', \
