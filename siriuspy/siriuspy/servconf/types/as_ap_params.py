...
_tb_sofb = [
    ...
    ['TB-Glob:AP-SOFB:DeltaFactorCH-SP', 0.0, 0.0],
    ['TB-Glob:AP-SOFB:DeltaFactorCV-SP', 0.0, 0.0],
    ...
    ['TB-Glob:AP-SOFB:NrSingValues-SP', 0, 0.0],
    ['TB-Glob:AP-SOFB:OrbAcqRate-SP', 0.0, 0.0],
    ['TB-Glob:AP-SOFB:SOFBMode-Sel', 0, 0.0],
    ['TB-Glob:AP-SOFB:OfflineOrbX-SP', [0.0, ]*6, 0.0],
    ['TB-Glob:AP-SOFB:OfflineOrbY-SP', [0.0, ]*6, 0.0],
    ['TB-Glob:AP-SOFB:RefOrbX-SP', [0.0, ]*6, 0.0],
    ['TB-Glob:AP-SOFB:RefOrbY-SP', [0.0, ]*6, 0.0],
    ...
    ['TB-Glob:AP-SOFB:TrigExtDelay-SP', 0.0, 0.0],
    ['TB-Glob:AP-SOFB:TrigExtDuration-SP', 0.0, 0.0],
    ['TB-Glob:AP-SOFB:TrigExtEvtSrc-Sel', 0, 0.0],
...
_bo_sofb = [
    ['BO-Glob:AP-SOFB:ClosedLoopFreq-SP', 0.0, 0.0],
    ...
    ['BO-Glob:AP-SOFB:DeltaFactorCH-SP', 0.0, 0.0],
    ['BO-Glob:AP-SOFB:DeltaFactorCV-SP', 0.0, 0.0],
    ['BO-Glob:AP-SOFB:DeltaFactorRF-SP', 0.0, 0.0],
    ...
    ['BO-Glob:AP-SOFB:NrSingValues-SP', 0, 0.0],
    ['BO-Glob:AP-SOFB:OrbAcqRate-SP', 0.0, 0.0],
    ['BO-Glob:AP-SOFB:SOFBMode-Sel', 0, 0.0],
    ['BO-Glob:AP-SOFB:MTurnIdx-SP', 0, 0.0],
    ['BO-Glob:AP-SOFB:OfflineOrbX-SP', [0.0, ]*50, 0.0],
    ['BO-Glob:AP-SOFB:OfflineOrbY-SP', [0.0, ]*50, 0.0],
    ['BO-Glob:AP-SOFB:RefOrbX-SP', [0.0, ]*50, 0.0],
    ['BO-Glob:AP-SOFB:RefOrbY-SP', [0.0, ]*50, 0.0],
    ...
    ['BO-Glob:AP-SOFB:TrigDownSample-SP', 0, 0.0],
    ['BO-Glob:AP-SOFB:TrigExtDelay-SP', 0.0, 0.0],
    ['BO-Glob:AP-SOFB:TrigExtDuration-SP', 0.0, 0.0],
    ['BO-Glob:AP-SOFB:TrigExtEvtSrc-Sel', 0, 0.0],
...
_ts_sofb = [
    ...
    ['TS-Glob:AP-SOFB:DeltaFactorCH-SP', 0.0, 0.0],
    ['TS-Glob:AP-SOFB:DeltaFactorCV-SP', 0.0, 0.0],
    ...
    ['TS-Glob:AP-SOFB:NrSingValues-SP', 0, 0.0],
    ['TS-Glob:AP-SOFB:OrbAcqRate-SP', 0.0, 0.0],
    ['TS-Glob:AP-SOFB:SOFBMode-Sel', 0, 0.0],
    ['TS-Glob:AP-SOFB:OfflineOrbX-SP', [0.0, ]*5, 0.0],
    ['TS-Glob:AP-SOFB:OfflineOrbY-SP', [0.0, ]*5, 0.0],
    ['TS-Glob:AP-SOFB:RefOrbX-SP', [0.0, ]*5, 0.0],
    ['TS-Glob:AP-SOFB:RefOrbY-SP', [0.0, ]*5, 0.0],
    ...
    ['TS-Glob:AP-SOFB:TrigExtDelay-SP', 0.0, 0.0],
    ['TS-Glob:AP-SOFB:TrigExtDuration-SP', 0.0, 0.0],
    ['TS-Glob:AP-SOFB:TrigExtEvtSrc-Sel', 0, 0.0],
...
_si_sofb = [
    ['SI-Glob:AP-SOFB:ClosedLoopFreq-SP', 0.0, 0.0],
    ...
    ['SI-Glob:AP-SOFB:DeltaFactorCH-SP', 0.0, 0.0],
    ['SI-Glob:AP-SOFB:DeltaFactorCV-SP', 0.0, 0.0],
    ['SI-Glob:AP-SOFB:DeltaFactorRF-SP', 0.0, 0.0],
    ...
    ['SI-Glob:AP-SOFB:NrSingValues-SP', 0, 0.0],
    ['SI-Glob:AP-SOFB:OrbAcqRate-SP', 0.0, 0.0],
    ['SI-Glob:AP-SOFB:SOFBMode-Sel', 0, 0.0],
    ['SI-Glob:AP-SOFB:MTurnIdx-SP', 0, 0.0],
    ['SI-Glob:AP-SOFB:OfflineOrbX-SP', [0.0, ]*160, 0.0],
    ['SI-Glob:AP-SOFB:OfflineOrbY-SP', [0.0, ]*160, 0.0],
    ['SI-Glob:AP-SOFB:RefOrbX-SP', [0.0, ]*160, 0.0],
    ['SI-Glob:AP-SOFB:RefOrbY-SP', [0.0, ]*160, 0.0],
    ...
    ['SI-Glob:AP-SOFB:TrigDownSample-SP', 0, 0.0],
    ['SI-Glob:AP-SOFB:TrigExtDelay-SP', 0.0, 0.0],
    ['SI-Glob:AP-SOFB:TrigExtDuration-SP', 0.0, 0.0],
    ['SI-Glob:AP-SOFB:TrigExtEvtSrc-Sel', 0, 0.0],
