...
DEFAULT_RAMP_RAMPUP_START_TIME = 12.743185796449112  # [ms]
DEFAULT_RAMP_INJECTION_TIME = 19.604901225306328  # [ms]
DEFAULT_RAMP_EJECTION_TIME = 294.07351837959493  # [ms]
DEFAULT_RAMP_RAMPUP_STOP_TIME = 303.87596899224803  # [ms]
DEFAULT_RAMP_RAMPDOWN_START_TIME = 335.24381095273816  # [ms]
DEFAULT_RAMP_RAMPDOWN_STOP_TIME = 470.5176294073518  # [ms]

DEFAULT_RAMP_START_ENERGY = 0.03  # [GeV]
DEFAULT_RAMP_RAMPUP_START_ENERGY = 0.07875  # [GeV]
DEFAULT_RAMP_RAMPUP_STOP_ENERGY = 3.1017857142857137  # [GeV]
DEFAULT_RAMP_PLATEAU_ENERGY = 3.15  # [GeV]
DEFAULT_RAMP_RAMPDOWN_START_ENERGY = 3.0  # [GeV]
DEFAULT_RAMP_RAMPDOWN_STOP_ENERGY = 0.21  # [GeV]
