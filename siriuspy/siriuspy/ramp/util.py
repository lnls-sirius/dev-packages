...
# NOTE: these parameters should be updated
DEFAULT_PS_RAMP_DURATION = 490.0  # [ms]
DEFAULT_PS_RAMP_RAMPUP1_START_TIME = 10.0  # [ms]
DEFAULT_PS_RAMP_RAMPUP2_START_TIME = 130.0  # [ms]
DEFAULT_PS_RAMP_RAMPDOWN_START_TIME = 380.0  # [ms]
DEFAULT_PS_RAMP_RAMPDOWN_STOP_TIME = 485.0  # [ms]
DEFAULT_PS_RAMP_RAMPUP_RANGE = 60.0  # [ms]
DEFAULT_PS_RAMP_RAMPDOWN_RANGE = 60.0  # [ms]

DEFAULT_PS_RAMP_START_ENERGY = 30.0  # [GeV]
DEFAULT_PS_RAMP_RAMPUP1_START_ENERGY = 40.0  # [GeV]
DEFAULT_PS_RAMP_RAMPUP2_START_ENERGY = 175.0  # [GeV]
DEFAULT_PS_RAMP_RAMPDOWN_START_ENERGY = 1000.0  # [GeV]
DEFAULT_PS_RAMP_RAMPDOWN_STOP_ENERGY = 40.0  # [GeV]
DEFAULT_PS_RAMP_RAMPUP_DELTA = 1*5.0  # [GeV]
DEFAULT_PS_RAMP_RAMPDOWN_DELTA = 1*80.0  # [GeV]


# Power supply ramp parameters
# NOTE: these parameters will eventually be deleted
# DEFAULT_PS_RAMP_DURATION = 490.0  # [ms]
