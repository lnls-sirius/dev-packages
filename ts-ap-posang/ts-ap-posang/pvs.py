...
pvs_database['TS-Glob:AP-PosAng:'] = {
    ...
    'OrbXDeltaAng-SP': {'type':'float', 'count': 1, 'value': 0, 'prec': 3, 'unit': 'mrad', 'hilim': 3.14, 'lolim': -3.14},
    ...
    'OrbYDeltaAng-SP': {'type':'float', 'count': 1, 'value': 0, 'prec': 3, 'unit': 'mrad', 'hilim': 3.14, 'lolim': -3.14},
